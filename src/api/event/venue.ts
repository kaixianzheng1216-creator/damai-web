...
export const fetchAdminVenuesPage = (params?: VenuePageRequest): Promise<PageResponseVenueVO> =>
  request.get<PageResponseVenueVO>('/api/event/admin/venues/page', { params })
